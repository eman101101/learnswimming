...
### Passing
If you need to pass someone, do so on the left side. Make sure the lane is clear before you pass someone. If someone is trying to pass you, move towards the lane rope and let them pass.
