...
The Breaststroke is the oldest known swimming stroke and is one of four strokes used in competitive swimming. This stroke is also very popular in recreational swimming because the head can be held up, making vision and breathing easy and because the swimmer can rest between strokes if needed. The Breaststroke is the slowest of the four competitive strokes, but that doesn't mean it's easy to do well. It requires excellent timing, coordination, and technique to perform correctly. In this article, we'll cover the basics of the Breaststroke, including the arm stroke, leg kick, timing, and breathing. We'll also discuss common mistakes and how to correct them.
